  ...
  <div>
    ...
    <el-table :data="catelist">
      ...
      <template v-slot="scope">
        <el-button type="primary" size="mini" @click="$router.push(`/articles/edit/${scope.row._id}`)">编辑</el-button>
...
export default {
  ...
  methods: {
    ...
    // 删除分类
    async remove(row) {
       const isRemove = await this.$confirm(`此操作将永久删除文章 "${row.title}" , 是否继续?`, '提示', {
